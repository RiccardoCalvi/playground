class LaDimoraCards extends HTMLElement {
	...
	getIcon(type) {
		switch(type) {
			...
			case "Parcheggio":
				return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Pro 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2025 Fonticons, Inc.--><path class="fa-secondary" opacity=".4" fill="#f8941d" d="M0 96L0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32C28.7 32 0 60.7 0 96zm128 72c0-22.1 17.9-40 40-40l72 0c53 0 96 43 96 96s-43 96-96 96l-48 0 0 32c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-64 0-120zm64 24l0 64 48 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-48 0z"/><path class="fa-primary" fill="#f8941d" d="M192 192l0 64 48 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-48 0zm144 32c0 53-43 96-96 96l-48 0 0 32c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-64 0-120c0-22.1 17.9-40 40-40l72 0c53 0 96 43 96 96z"/></svg>`
			default:
				return '';
		}
	}
